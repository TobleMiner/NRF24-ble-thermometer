...
static gpio_t gpios_g[] = {
	...
	{ GPIOA, GPIO4,  GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, 0, GPIO_OSPEED_2MHZ, 0, GPIO_FLAG_INVERTED },  // SPI1 NSS
	{ GPIOA, GPIO5,  GPIO_MODE_AF,     GPIO_PUPD_NONE, 0, GPIO_OSPEED_25MHZ, GPIO_AF0, GPIO_FLAG_FORCE_OUT_OPT },            // SPI1 SCK
	{ GPIOA, GPIO6,  GPIO_MODE_AF,     GPIO_PUPD_NONE, 0, GPIO_OSPEED_25MHZ, GPIO_AF0, GPIO_FLAG_FORCE_OUT_OPT },            // SPI1 MISO
	{ GPIOA, GPIO7,  GPIO_MODE_AF,     GPIO_PUPD_NONE, 0, GPIO_OSPEED_25MHZ, GPIO_AF0, GPIO_FLAG_FORCE_OUT_OPT },            // SPI1 MOSI
